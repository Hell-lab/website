+++
title = "Frequently Asked Questions, or everything you ever wanted to know about the event"
+++

{{< faqaccordion >}}

{{< faqtopic title="Brief overview" open="true">}}
...
Set-up takes place from 22 August to 26 August. Dismantling begins on the day of departure, 30 August, and ends on 3 September. If you’d like to help with set-up or dismantling, please contact kontakt@hack-mas.at.
...
Yes. You can find further information here: [Photo and Video Policy]({{< relref "codeofconduct/photo-policy.md" >}})
...
{{< faqtopic title="Arrival and departure">}}
### How do I actually get there (by public transport) to this Void … er, Waldviertel?  
We have [travel information]({{< relref "anreise/_index.md" >}}).
...
No. On the main arrival day (Wednesday), there are several public transport connections. On the main departure day (Sunday), we have organised a [hhuttle Service]({{< relref "anreise/shuttle.md" >}})  using a coach. 
You can find the public transport timetable on the ÖBB website (Ottenschlag near Bad Traunstein) (https://fahrplan.oebb.at/webapp/)  
...
{{< faqtopic title="Sanitary facilities">}}
...
{{< faqtopic title="Projects">}}
### Where can I set up my project or large structure?  
The castle courtyard is large, but not infinite. If you are planning a larger structure such as an event tent or a dome, please contact kontakt@hack-mas.at by 15 May at the latest. You can find all the details on the [infrastructure page]({{< relref "mitmachen/zelte.md" >}}).  
...
{{< /faqtopic >}}
{{< faqtopic title="Further questions">}}
